...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (str.equals("Save")) {			
			...
			if (filename != null) {
//				getGraph().save(chooser.getDirectory() + File.separator + chooser.getFile());
			}
		}
		if (str.equals("Load")) {
			...
			if (filename2 != null) {
//				getGraph().init(chooser2.getDirectory() + File.separator + chooser2.getFile());
				
			}
		}
		if (str.equals("ShortestPath")) {
//			this.getGraphics().drawString("please choose src node and dest node", 202, 202);
//			JFrame f = new JFrame("ShortestPath");
//			JLabel sp = new JLabel();
//			sp.setText("please choose src node and dest node");
//			JPanel p = new JPanel();
//			p.add(sp);
//			f.add(p);
//			f.setSize(350, 150);
...
//			System.out.println(getGraph().isConnected());
//			if(getGraph().isConnected()==true) {
//				StdDraw.text(-4, -4, "true");
//			}
//			else {
//				StdDraw.text(-4, -4, "false");
//			}
		}
