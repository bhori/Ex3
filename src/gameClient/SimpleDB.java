...
//				String allCustomersQuery = "SELECT * FROM Logs where levelID="+0;
				...
				{
					System.out.println(ind+") Id: " + resultSet.getInt("UserID")+", level: "+resultSet.getInt("levelID")+", moves: "+resultSet.getInt("moves")
					+", time: "+resultSet.getDate("time")+", score: "+resultSet.getInt("score")+", time: "+resultSet.getDate("time"));
					ind++;
				}
				resultSet.close();
				statement.close();		
